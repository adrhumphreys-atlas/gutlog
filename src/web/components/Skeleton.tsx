    ...
    <div className="space-y-2 animate-pulse" aria-hidden="true">
      {[1, 2, 3, 4].map((i) => (
        ...
        >
          ...
          <div className="w-12 h-3 rounded bg-stone-200" />
  ...
  return (
    <div className="space-y-3 animate-pulse" aria-hidden="true">
      {[1, 2, 3].map((i) => (
        <div
          key={i}
          className="bg-purple-50/50 border border-purple-100 rounded-2xl p-4"
        >
          ...
          <div className="h-8 w-full rounded-xl bg-purple-100" />
        </div>
      ))}
    </div>
  )
